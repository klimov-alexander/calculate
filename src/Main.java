...
class Calculator {
    ...
    public static void main(String[] args) {
        ...
        // Заполняем символьный массив символами строки которую ввел пользователь и по
        // ходу ловим знак операции
        ...
        number1 = numberRom(stable00);
        number2 = numberRom(string03);
    ...
    private static String convertNumToRoman(int numArabian) {
        String[] rom = { "O", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII", "XIII", "XIV",
        ...
        final String num = rom[numArabian];
        return num;
    }

    private static int numberRom(String rom) {
        try {
            switch (rom) {
                case "I" -> {
                    return 1;
